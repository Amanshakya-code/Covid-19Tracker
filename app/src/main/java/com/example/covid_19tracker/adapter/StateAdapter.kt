...
import com.example.covid_19tracker.SpannableDelta
import com.example.covid_19tracker.StatewiseItem
import kotlinx.android.synthetic.main.singleitemlist.view.*
...
class stateAdapter(val list: List<StatewiseItem>) : BaseAdapter(){
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        val view = convertView?: LayoutInflater.from(parent?.context).inflate(R.layout.singleitemlist,parent,false)
